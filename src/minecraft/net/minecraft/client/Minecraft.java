...
import com.jay.immoral.client.events.EventMiddleClick;
import com.jay.immoral.client.events.EventTick;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
	...
	public Minecraft(GameConfiguration p_i45547_1_) {
		...
		if (p_i45547_1_.field_178742_e.field_178754_a != null) {
			...
			// Lambent Client
			EventManager.register(new com.jay.immoral.client.Client());
		}
	...
	private void startGame() throws LWJGLException {
		...
		// Lambent Client
		new com.jay.immoral.client.Client().initializeClient();
	...
	public void runTick() throws IOException {
		...
		EventManager.register(eventTick);
