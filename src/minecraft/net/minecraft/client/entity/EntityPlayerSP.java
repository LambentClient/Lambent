...
import com.jay.immoral.client.events.update.EventAfterUpdate;
import com.jay.immoral.client.events.update.EventBeforeUpdate;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void onUpdate()
    {
        if (this.worldObj.isBlockLoaded(new BlockPos(this.posX, 0.0D, this.posZ)))
        {
        	...
        	//Lambent Client [event]
        	//Called Before EventUpdate
        	EventBeforeUpdate beforeEventUpdate = new EventBeforeUpdate();
        	EventManager.call(beforeEventUpdate);
        	...
        	//Lambent Client [event]
        	//Called After EventUpdate
        	EventAfterUpdate afterEventUpdate = new EventAfterUpdate();
        	EventManager.call(afterEventUpdate);
